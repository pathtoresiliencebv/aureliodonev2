...
export const SITE_NAME = "Aurelio"
export const SITE_DESCRIPTION = "A modern e-commerce platform built with Next.js 15 and Cloudflare Workers, designed for scalability and performance."
